...
def P2PKH_scriptSig(txin, txout, txin_scriptPubKey, private_key, public_key):
    signature = create_OP_CHECKSIG_signature(
        txin, txout, txin_scriptPubKey, private_key
    )
    ######################################################################
...
def send_from_P2PKH_transaction(
    amount_to_send,
    txid_to_spend,
    utxo_index,
    txout_scriptPubKey,
    ...
    txin_scriptSig = P2PKH_scriptSig(
        txin, txout, txin_scriptPubKey, sender_private_key, sender_public_key
    )
...
if __name__ == "__main__":
    ...
    # faucet gave me coins in this transaction
    txid_to_spend = "86ab333aad4c4d3cb6f26aa2c2053cb762392c229270480f76cdbe44dec35a99"
