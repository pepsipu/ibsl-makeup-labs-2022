...
my_private_key = CBitcoinSecret("cPuVxq9t6gb8GpbSti5xkdvJHRxgQi5N2sGbCdYtK5fyJHf4J2qq")
...
alice_secret_key_BTC = CBitcoinSecret(
    "cNuHhJgPL7DwMcTkR7nStXjjr4SQhtDsKiKrZPMFa7uwvs4ssv2o"
)

# Only to be imported by bob.py
bob_secret_key_BTC = CBitcoinSecret(
    "cTJhxKR5kSNWgQM65NHK2JvL2fnoRq9AA4xNJhNq55eoXx4C3jEi"
)
